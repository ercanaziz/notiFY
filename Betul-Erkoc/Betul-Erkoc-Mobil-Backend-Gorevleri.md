# Betül Erkoç — Mobil Backend Görevleri
...
**Açıklama:** Kayıtlı kullanıcıların kimlik doğrulamasını yaparak sistem erişim izni almasını ve JWT token üretilmesini sağlar.
...
## 4. Şifre Değiştirme
**API Metodu:** `PATCH /api/users/password`
